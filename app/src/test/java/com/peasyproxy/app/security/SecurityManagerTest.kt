...
class SecurityManagerTest {
    ...
    fun setup() {
        ...
        every { mockKeyStore.containsAlias("peasyproxy_master_key") } returns false
        every { mockKeyStore.getEntry("peasyproxy_master_key", null) } returns mockk<SecretKeyEntry> {
