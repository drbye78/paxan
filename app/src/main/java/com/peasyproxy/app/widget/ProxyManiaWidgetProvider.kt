package com.peasyproxy.app.widget
...
class PeasyProxyWidgetProvider : AppWidgetProvider() {
    ...
    companion object {
        const val ACTION_CONNECT = "com.peasyproxy.app.WIDGET_CONNECT"
        const val ACTION_DISCONNECT = "com.peasyproxy.app.WIDGET_DISCONNECT"
