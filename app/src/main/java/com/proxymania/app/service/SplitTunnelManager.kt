...
import com.proxymania.app.domain.model.AppBundle
import com.proxymania.app.domain.model.AppCategory
import com.proxymania.app.domain.model.SplitTunnelConfig
        ...
        when (config.mode) {
            SplitTunnelMode.INCLUDE, SplitTunnelMode.DISABLED -> {
                settingsRepository.updateAppRoutingConfig(
                    com.proxymania.app.domain.model.AppRoutingConfig(
