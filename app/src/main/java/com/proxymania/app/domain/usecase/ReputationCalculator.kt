package com.proxymania.app.domain.usecase
...
class ReputationCalculator @Inject constructor() {
    ...
    private fun calculateBaseTrustScore(proxy: Proxy): Float {
        ...
        when (proxy.protocol) {
            com.proxymania.app.domain.model.ProxyProtocol.HTTPS -> score += 10f
            com.proxymania.app.domain.model.ProxyProtocol.SOCKS5 -> score += 5f
            com.proxymania.app.domain.model.ProxyProtocol.SOCKS4 -> score += 5f
            else -> {}
        }
